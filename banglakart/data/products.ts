...
export const PRODUCTS: Product[] = [
  {
    id: "prod-1",
    name: "Premium Bengal Jamdani Saree",
    banglaName: "প্রিমিয়াম বেঙ্গল জামদানি শাড়ি",
  ...
  {
    id: "prod-2",
    name: "Pure Murshidabad Silk Saree",
    banglaName: "খাঁটি মুর্শিদাবাদ সিল্ক শাড়ি",
  ...
  },
  {
    ...
    banglaOrigin: "সুন্দরবন, পশ্চিমবঙ্গ",
  ...
  {
    id: "prod-4",
    name: "Premium Darjeeling Black Tea",
    banglaName: "দার্জিলিংয়ের প্রিমিয়াম চা পাতা",
    description: "Finest hand-plucked Orthodox black tea from the lush green hills of Darjeeling. Rich, full-bodied flavor with a subtle malty finish.",
    banglaDescription: "দার্জিলিংয়ের সবুজ পাহাড় থেকে সংগৃহীত হাতে বাছাই করা প্রিমিয়াম ব্ল্যাক টি। চমৎকার কড়া স্বাদ ও সুগন্ধযুক্ত।",
    price: 450,
    category: "food",
    rating: 4.6,
    reviewsCount: 112,
    origin: "Darjeeling, West Bengal",
    banglaOrigin: "দার্জিলিং, পশ্চিমবঙ্গ",
    story: "Darjeeling is known as the 'Tea Capital' of West Bengal. This tea is sourced from rain-fed estates that produce some of the finest single-origin black teas in South Asia.",
    banglaStory: "দার্জিলিংকে পশ্চিমবঙ্গের চায়ের রাজধানী বলা হয়। এই চা পাতা দার্জিলিং অঞ্চলের শতাব্দী প্রাচীন চা বাগান থেকে সরাসরি সংগৃহীত।",
    inStock: true,
    imageSvg: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 500" class="w-full h-full"><rect width="100%" height="100%" fill="url(#bg-tea)"/><defs><linearGradient id="bg-tea" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stop-color="#f0f7f4"/><stop offset="100%" stop-color="#d8ebd4"/></linearGradient></defs><g stroke="#006a4e" stroke-width="3" fill="none"><path d="M 130 250 C 130 180, 270 180, 270 250 C 270 320, 130 320, 130 250 Z" fill="#006a4e" opacity="0.1"/><path d="M 150 250 Q 200 210 250 250 Q 200 290 150 250" fill="#006a4e"/><path d="M 200 210 L 200 290 M 175 230 L 225 270 M 225 230 L 175 270" stroke="#fff" stroke-width="1.5"/><path d="M 200 130 Q 180 150 200 170 Q 220 150 200 130 Z" fill="#d4af37"/></g><path d="M 120 340 Q 200 370 280 340" fill="none" stroke="#006a4e" stroke-width="4" stroke-linecap="round"/><text x="50%" y="85%" text-anchor="middle" fill="#006a4e" font-family="sans-serif" font-weight="bold" font-size="18" letter-spacing="2">DARJEELING HARVEST</text></svg>`,
  },
  {
    id: "prod-5",
    name: "Hand-Stitched Bengal Nakshi Kantha",
    banglaName: "হাতে সেলাই করা বেঙ্গল নকশী কাঁথা",
  ...
  {
    id: "prod-6",
    name: "Handcrafted Bengal Clay Tea Set",
    ...
    origin: "West Bengal",
    banglaOrigin: "পশ্চিমবঙ্গ",
    story: "West Bengal is historical for its potters (Kumbhakar community) who have preserved the traditional art of Bengali terracotta pottery for generations.",
    banglaStory: "পশ্চিমবঙ্গ মৃৎশিল্পীদের (কুমার সম্প্রদায়) জন্য ঐতিহাসিকভাবে বিখ্যাত, যারা প্রজন্মের পর প্রজন্ম ধরে বাঙালি পোড়ামাটির ঐতিহ্যবাহী শিল্পকে টিকিয়ে রেখেছেন।",
    inStock: true,
  ...
  },
  {
    ...
    origin: "West Bengal",
    banglaOrigin: "পশ্চিমবঙ্গ",
    story: "Tant sarees are a staple of Bengali culture, woven by expert artisans in West Bengal using soft cotton yarn and timeless striped borders.",
    banglaStory: "তান্ট শাড়ি বাঙালি সংস্কৃতির একটি পরিচিত পোশাক, পশ্চিমবঙ্গের দক্ষ কারিগরেরা নরম সুতি সুতা ও ঐতিহ্যবাহী ডোরাকাটা দিয়ে বোনেন।",
    inStock: true,
  ...
  {
    id: "prod-9",
    name: "Dooars Herbal Tea Sampler",
    banglaName: "ডুয়ার্স হার্বাল টি স্যাম্পলার",
    description: "A curated collection of three fragrant herbal tea blends sourced from Dooars, packaged as a premium gifting set.",
    banglaDescription: "ডুয়ার্স থেকে সংগৃহীত তিনটি সুবাসিত হার্বাল চা ব্লেনের একটি নির্বাচিত সংগ্রহ, প্রিমিয়াম উপহারের জন্য সাজানো।",
    price: 2000,
    category: "food",
    rating: 4.6,
    reviewsCount: 27,
    origin: "Dooars Forest",
    banglaOrigin: "ডুয়ার্স বন",
    story: "These herbal blends are made from wild-grown lemongrass, basil, and local mint, hand-picked by tea farmers near the Dooars jungle region.",
    banglaStory: "এই হার্বাল ব্লেনগুলো লেমনগ্রাস, তুলসী ও স্থানীয় পুদিনা থেকে তৈরি, যা ডুয়ার্সের বনাঞ্চলের কাছের চাষিদের দ্বারা হাতে তোলা।",
    inStock: true,
